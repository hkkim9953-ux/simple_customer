...
import MyReservationList from "@/components/reservations/MyReservationList";
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-muted">
            예약한 일정을 확인하고 필요하면 취소할 수 있습니다.
          </p>
        </div>
        <Link
          href="/reserve"
          className="inline-flex items-center justify-center rounded-md bg-foreground px-4 py-2.5 text-sm font-medium text-surface transition-opacity hover:opacity-85"
        >
          새 예약
        </Link>
      </div>
